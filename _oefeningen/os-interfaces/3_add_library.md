...
> :bulb: In UNIX-gebaseerde besturingssystemen gebruiken user programmas "file descriptors" om bestanden aan te duiden wanneer ze met het besturingssysteem communiceren. Dit zal in latere oefenzittingen nog uitgebreid aan bod komen. Voorlopig is het voldoende om te begrijpen dat de terminal (`stdout`) ook als een speciaal bestand kan worden gespecifieerd d.m.v. een speciale file descriptor met vast nummer 1.
